...
export default function SmadAnalysesList() {
    ...
    useDocumentTitle(t('analyse_smad', { defaultValue: "SMAD tahlillari" }));
    ...
    return (
        <div>
            <div className="main_card">
                <h1>
                    <span>
                        {t('analyse_smad', { defaultValue: 'SMAD Tahlillar' })}
                    ...
                    >
                        {t('create_new_smad_analyse', { defaultValue: 'Yangi SMAD tahlil' })}
                    </button>
                </h1>
                            ...
                            locale={{
                                emptyText: (
                                    ...
                                    activeFilterCount > 0 ? (
                                        ...
                                        <EmptyState
                                            icon={<FaHeartbeat />}
                                            message={t('no_smad_analyses', { defaultValue: 'Hech qanday SMAD tahlil topilmadi' })}
                                            actionLabel={t('new_smad_analyse', { defaultValue: 'Yangi SMAD tahlil' })}
