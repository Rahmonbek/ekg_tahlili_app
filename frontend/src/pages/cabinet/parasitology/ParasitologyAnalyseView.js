...
export default function ParasitologyAnalyseView() {
    const { id } = useParams();
    ...
    return (
        <div>
            <AnalyseViewHeader
                t={t}
                onBack={() => navigate('/parasitology-analyses')}
            ...
            <ParasitologyOldResult data={data} initialOpen={true} showDownloadButton={false} />
