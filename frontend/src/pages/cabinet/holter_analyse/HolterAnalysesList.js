                        ...
                        <Row gutter={[12, 12]} align="bottom">
                            ...
                            <Col xs={24} sm={12} md={4}>
                                <div style={{ display: 'flex', gap: 8, height: '48px' }}>
                                    ...
                                    <button onClick={() => navigate('/analyse-holter')} className="btn_form text-white" style={{ width: '50px', margin: 0, height: '48px', backgroundColor: '#00D1B2', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                        <FaPlus />
                                    </button>
                                </div>
                            </Col>
