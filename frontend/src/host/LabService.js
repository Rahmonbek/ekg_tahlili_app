 ...
 */
export const analyzeLabFile = async (formData, options = {}) => {
...
export const replaceLabFile = async (formData) => {
  const res = await axiosInstance.post(`/lab-analyses/replace-file`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
    timeout: 300000,
  });
  return res.data;
