# NMED EKG Tahlili App — Codex Yo'riqnomasi
...
Qo'shimcha kontekst: [.Codex/agent-memory/nmed-system-architect/MEMORY.md](.Codex/agent-memory/nmed-system-architect/MEMORY.md)
